...
#    Updated: 2022/05/23 12:55:45 by abellakr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS_FILE =  ft_lstadd_front.c ft_lstsize.c ft_lstlast.c ft_lstadd_back.c ft_lstnew.c
...
$(BONUS_OBJ):	$(BONUS_FILE)
		@gcc -Wall -Werror -Wextra -c  $(BONUS_FILE)
clean:
